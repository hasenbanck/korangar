...
/// rendering.
///
/// This uses "reverse Z" with a z-axis which helps greatly with Z
/// fighting.
///
...
/// to 0.0 (far).
pub fn orthographic_reverse_lh(left: f32, right: f32, bottom: f32, top: f32, near: f32, far: f32) -> Matrix4<f32> {
    ...
    Matrix4::from_cols(
        ...
        Vector4::new(-(left + right) * width, -(top + bottom) * height, depth * far, 1.0),
    )
}
