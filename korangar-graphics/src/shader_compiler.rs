...
/// Loads and compiles SPIR-V shaders from an embedded 7z archive.
...
impl ShaderCompiler {
    /// Creates a new shader compiler by extracting shader metadata from the
    /// embedded 7z archive.
    ...
    /// Creates a shader module by loading and decompressing the specified
    /// SPIR-V shader from the archive.
