...
use crate::passes::mipmap::MipMapRenderPassContext;
use crate::shader_compiler::ShaderCompiler;

const DRAWER_NAME: &str = "lanczos3";

/// Drawer that generates mipmaps using a Lanczos3 resampling kernel for
...
impl Lanczos3Drawer {
    ...
    /// Draws a fullscreen triangle to generate the mipmap level.
