...
use crate::passes::{BindGroupCount, ComputePassContext, Dispatch, SdsmPassContext};
use crate::shader_compiler::ShaderCompiler;
use crate::{Capabilities, GlobalContext};

const DISPATCHER_NAME: &str = "clear partitions";

pub(crate) struct ClearPartitionsDispatcher {
    pipeline: ComputePipeline,
}

impl Dispatch<{ BindGroupCount::Two }> for ClearPartitionsDispatcher {
    ...
    fn new(
        ...
        let shader_module = shader_compiler.create_shader_module("sdsm", "clear_partitions");
