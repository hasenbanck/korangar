...
use crate::{Buffer, Capabilities, GlobalContext, Prepare, RenderInstruction, SimpleVertex};
...
impl Drawer<{ BindGroupCount::One }, { ColorAttachmentCount::One }, { DepthAttachmentCount::None }> for DebugRectangleDrawer {
    ...
    fn new(
        ...
        let shader_module = shader_compiler.create_shader_module("postprocessing", "debug_rectangle");
