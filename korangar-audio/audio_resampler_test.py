...
Usage:
    1. Generate test files:
       python audio_resampler_test.py generate --input-rate 22050 --output-rate 48000

    2. Run your resampler on the generated files:
       ./your_resampler test_impulse.wav test_impulse_resampled.wav
       ./your_resampler test_sweep.wav test_sweep_resampled.wav

    3. Analyze results:
       python audio_resampler_test.py analyze --input-rate 22050 --output-rate 48000
"""
