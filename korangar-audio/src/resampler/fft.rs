...
use error::{ResampleError, ResamplerConstructionError};
...
impl<const CHANNEL: usize, T: FftCache> Fft<CHANNEL, T> {
    ...
    pub(crate) fn new(sample_rate_input: usize, sample_rate_output: usize, chunk_size: usize) -> Result<Self, ResamplerConstructionError> {
