...
const DRAWER_NAME: &str = "directional shadow EVSM indicator";

pub(crate) struct DirectionalShadowEvsmIndicatorDrawer {
    bind_group: BindGroup,
    pipeline: RenderPipeline,
}

impl Drawer<{ BindGroupCount::Two }, { ColorAttachmentCount::One }, { DepthAttachmentCount::One }> for DirectionalShadowEvsmIndicatorDrawer {
    ...
    fn new(
        ...
        let shader_module = shader_compiler.create_shader_module("directional_shadow", "indicator_evsm");
