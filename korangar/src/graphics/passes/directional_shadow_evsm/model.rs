...
use crate::graphics::passes::{
    BindGroupCount, ColorAttachmentCount, DepthAttachmentCount, DirectionalShadowEvsmRenderPassContext, DrawIndexedIndirectArgs, Drawer,
...
const DRAWER_NAME: &str = "directional shadow EVSM model";
...
pub(crate) struct DirectionalShadowEvsmModelDrawer {
...
impl Drawer<{ BindGroupCount::Two }, { ColorAttachmentCount::One }, { DepthAttachmentCount::One }> for DirectionalShadowEvsmModelDrawer {
    ...
    fn new(
        ...
        let shader_module = match capabilities.bindless_support() {
            BindlessSupport::Full | BindlessSupport::Limited => {
                shader_compiler.create_shader_module("directional_shadow", "model_evsm_bindless")
            }
            BindlessSupport::None => shader_compiler.create_shader_module("directional_shadow", "model_evsm"),
        };
...
impl Prepare for DirectionalShadowEvsmModelDrawer {
...
impl DirectionalShadowEvsmModelDrawer {
