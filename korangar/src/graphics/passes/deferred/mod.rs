...
const PASS_NAME: &str = "deferred render pass";

pub(crate) struct DeferredRenderPassContext {
...
impl Prepare for DeferredRenderPassContext {}

impl RenderPassContext<{ BindGroupCount::None }, { ColorAttachmentCount::Three }, { DepthAttachmentCount::One }>
    for DeferredRenderPassContext
{
